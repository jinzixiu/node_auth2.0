...
API_OAUTH2_AUTHORIZE  = API_URL + '/OAuth2/authorize';
API_OAUTH2_ACCESS_TOKEN = API_URL + '/OAuth2/access_token';
API_ARTICLES = API_URL + '/api/v1/articles.json';
